...
def rank_resumes(request: ResumeRequest):
    ...
    return [
        ResumeResponse(
            ...
            highlights=["Built scalable REST APIs", "Integrated Kafka streaming", "Led team of 4"],
            ...
            generatedSummary="A backend-focused engineer with proven impact in enterprise systems.",
            atsScore=8.4,
        ...
        ResumeResponse(
            ...
            highlights=["Improved ORM performance", "Built internal tools"],
            ...
            generatedSummary="A solid Java developer with foundational backend experiences.",
            atsScore=7.1,
